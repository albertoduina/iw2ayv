...
public class AboutBox {
	...
	public void aboutIW2AYV(String arg, String version1) {
		...
		text[0] = arg;
		text[1] = "IW2AYV";
		text[2] = "2007-2024_  Alberto Duina";
	...
	public void about(String arg, String version1) {
		...
		text[3] = "2007-2024  Alberto Duina";
	...
	public void about(String[] arg, String version1) {
		...
		text[before + 3] = "2007-2024  Alberto Duina";
	...
	public void credits(String[] arg, String credits1, String credits2, String version1) {
		// public void about(String arg, Class<?> myClass) {
		...
		text[before + 1] = "Azienda Spedali Civili di Brescia";
		text[before + 2] = "Servizio di Fisica Sanitaria";
		// text[before + 3] = "2007-2018 Alberto Duina";
		// text[before + 4] = "albertoduina@virgilio.it";
		text[before + 3] = credits1;
		text[before + 4] = credits2;
		...
		ip.drawString(text[6], xDim(text[6], ip, max), y);
		// y += 18;
		// ip.drawString(text[7], xDim(text[7], ip, max), y);
		// y += 18;
		// ip.drawString(text[8], xDim(text[8], ip, max), y);
		ImageWindow.centerNextImage();
