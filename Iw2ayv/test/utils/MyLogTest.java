...
public class MyLogTest {
	...
	public final void testWaitHereMessage() {
		MyLog.waitHere("questo � il messaggio");
	}
	
	@Test
	public final void testWaitHereTimeout() {
		MyLog.waitHere("questo � il messaggio", false, 2000);
	}
	@Test
	public final void testWaitHereNOTimeout() {
		MyLog.waitHere("questo � il messaggio", false, 0);
	}
	@Test
	public final void testWaitHereDebugTimeout() {
		MyLog.waitHere("questo � il messaggio", true, 2000);
	}
	@Test
	public final void testWaitHereDebugNOTimeout() {
		MyLog.waitHere("questo � il messaggio", true, 0);
	}
//	@Test
//	public final void testWaitHere1Timeout() {
//		MyLog.waitHere1("questo � il messaggio", false, 0);
//	}
