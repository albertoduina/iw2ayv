...
public class InputOutputTest {
	...
	@Test
	public final void testReadFileGeneric() {

		String CODE_FILE = "codici3Read.txt";
		String[] expected = { "BUSA_ 2 2 xxx p3rmn_", "BUSA_ 2 2 xxx p3rmn_",
				"BUSS_ 2 2 xxx p3rmn_", "S78S_ 4 4 C:SP7-8 p5rmn_" };
		boolean absolute = false;
		ArrayList<String> tabella1 = new InputOutput().readFileGeneric(
				CODE_FILE, absolute);
		String[] out = tabella1.toArray(new String[tabella1.size()]);
	...
	public final void testIsCommentTrue() {
		String riga = "// Questo � un commento";
	...
	public final void testIsCommentFalse() {
		String riga = "Questo NON � un commento";
		boolean result = InputOutput.isComment(riga);
	...
	public final void testStripSlashComment() {
		String riga = "Questo programma �/ una// grandissima stronzata";
		String result = InputOutput.stripSlashComment(riga);
		// System.out.printf("\nresult= " + result);
		assertTrue(result.equals("Questo programma �/ una"));
	}
	...
	public final void testStripSlashCommentInesistent() {
		...
		// System.out.printf("\nresult= " + result);
		assertTrue(result
				.equals("Questo programma �/ una/ grandissima stronzata"));
	}
	...
	public final void testStripComment() {
		...
		// System.out.printf("\nresult= " + result);
		assertTrue(result.equals("Questo programma � una stronzata"));
	...
	public final void testStripAllComments() {
		String riga = "Questo /*programma*/ � /*una*/ cagata /* bellissimo*/ molto //cagoso";
		String result = InputOutput.stripAllComments(riga);
		// System.out.printf("\nresult= " + result);
		assertTrue(result.equals("Questo  �  cagata  molto "));
